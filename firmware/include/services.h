...
/* Service: Aero Config - Characteristic: Aero Config RX - Pipe: RX_ACK_AUTO */
#define PIPE_AERO_CONFIG_AERO_CONFIG_RX_RX_ACK_AUTO          8
#define PIPE_AERO_CONFIG_AERO_CONFIG_RX_RX_ACK_AUTO_MAX_SIZE 20

/* Service: Aero Config - Characteristic: Aero Config TX - Pipe: TX */
#define PIPE_AERO_CONFIG_AERO_CONFIG_TX_TX          9
#define PIPE_AERO_CONFIG_AERO_CONFIG_TX_TX_MAX_SIZE 20
